...
<body>
    ...
    <div class="title">
        <a href="dashboard.php"><img src="./images/NPSE.jpg" alt="" class="logo"></a>
        <span class="heading">Enter student info</span>
    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="text" name="p1" id="" placeholder="E.S.P&S">
                <input type="text" name="p2" id="" placeholder="Quantitative">
                <input type="text" name="p3" id="" placeholder="Verbal">
                <input type="text" name="p4" id="" placeholder="Mathematics">
                <input type="text" name="p5" id="" placeholder="General paper">
    ...
    <!-- <div class="footer">
        <span>Designed & members of group 3</span>
    </div> -->
